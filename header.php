...
if($path == '/login.php' || $path == '/register.php'):?>
<?php else: ?>
    <header id="header">
        <div class="header-main">
            <ul class="menu-list">
                <li class="menu-item">
                    <a class="board-btn" href="/"><span>Home</span></a>
                </li>
                <li class="menu-item">
                    <a class="board-btn" href="/board.php"><span>Board</span></a>
                </li>
                <li class="menu-item">
                    <a class="logout-btn" href="/logout.php"><span>Sign out</span></a>
                </li>
            </ul>
        </div>
    </header>
